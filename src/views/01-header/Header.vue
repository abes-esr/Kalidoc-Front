     ...
     <v-row :class="($vuetify.breakpoint.mdAndUp) ? 'pr-4 pb-4 pl-12 bgColorPrimary' : 'pa-2 bgColorPrimary'" justify="center" :align="($vuetify.breakpoint.mdAndUp) ? 'end' : 'start'" no-gutters>
       ...
       <v-col :cols="($vuetify.breakpoint.mdAndUp) ? '8' : '7'" :class="($vuetify.breakpoint.mdAndUp) ? 'pl-8' : null">
         <v-row class="ma-0 pa-0" justify="center" role="toolbar">
           <v-btn text tile color="white" value="interfaceVerification" :class="{titleBarButtonSelected: (route.path === '/') || (route.path === '/resultats') }" to="/">{{ ($vuetify.breakpoint.mdAndUp) ? 'Interface de vérification' : 'Vérification' }}</v-btn>
           <v-btn text tile color="white" value="interfaceRegles" :class="{titleBarButtonSelected: route.path === '/regles' }" to="/regles"> {{($vuetify.breakpoint.mdAndUp) ? 'Interface des règles' : 'Règles' }}</v-btn>
       ...
       <v-col :cols="($vuetify.breakpoint.mdAndUp) ? '2' : '3'">
         <v-row :class="($vuetify.breakpoint.mdAndUp) ? 'justify-center' : 'ma-0 pa-0 justify-end'" :no-gutters="$vuetify.breakpoint.mdAndUp">
           ...
           <v-btn :style="($vuetify.breakpoint.mdAndUp) ? 'margin-right: 10px' : 'margin-right: 3px'" fab :x-small="!$vuetify.breakpoint.mdAndUp" :small="$vuetify.breakpoint.mdAndUp" :depressed="$vuetify.breakpoint.mdAndUp" color="white" href="https://documentation.abes.fr/aidequalimarc/index.html" target="_blank">
